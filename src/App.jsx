...
async function exportSetupPDF({ policies, contactInfo, locations, locationScores, stats, overallScore, formatGoLiveDate, getBookingWindow }) {
  ...
  // PP Logo
  doc.addImage('data:image/png;base64,', 'PNG', m, 7, 52, 9);
